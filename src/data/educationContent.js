export const EDUCATION_CHAPTERS = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: 'Daftar Periksa Cepat MAD di Rumah:',
        checklist: [
          'Pola makan dan porsi sesuai dengan usia anak.',
          'Makanan bervariasi dari minimal 5 kelompok pangan setiap hari.',
          'Wajib ada Protein Hewani setiap hari (ikan, telur, ayam, daging, hati).',
          'Tekstur makanan dinaikkan bertahap sesuai usia.',
          'Makanan diolah secara bersih, aman, dan higienis.',
          'Pemberian ASI tetap dilanjutkan hingga usia 2 tahun atau lebih.',
          'Pantau pertumbuhan anak secara teratur setiap bulan di Posyandu.',
        ],
      },
    ],
  },
